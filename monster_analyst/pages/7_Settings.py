...
from monster_analyst.src.helpers import WINDOWS_11_CSS, downloadable_dataframe
from monster_analyst.src.metric_catalog import CATEGORIES, METRICS, METRICS_BY_CATEGORY
...
def render():
    ...
    with settings_tabs[2]:
        ...
        from monster_analyst.src.data_importer import COLUMN_ALIASES
